...
public class MigrateCmsToCdsApp {
	...
	public static void main(String[] args) {
		...
		CMSNameList carouselImageNames = cmsClient.getCarouselImageNames();
		if (carouselImageNames == null || carouselImageNames.getResponse_body().isEmpty()) {
			logger.info("Found no carousel image names, continuing");
		}
		else {
			for (String name : carouselImageNames.getResponse_body()) {
				logger.info("Processing carousel image {}", name);
			}
		}
