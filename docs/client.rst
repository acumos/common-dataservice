...
The client jar is deployed to these Nexus repositories:: 
	...
	<repository>
		<id>snapshots</id>
		<url>http://to-be-determined.org:8081/repository/repo_snapshot_to_be_determined</url> 
	</repository>
	<repository>
		<id>releases</id>
		<url>http://to-be-determined.org:8081/repository/repo_to_be_determined</url> 
	</repository>
