...
* Task type code - required
     ...
     -   Represents the type of action being tracked, for example onboarding of ML model workflow or verification of a ML model.
...
about the status and outcome of every step in the task of on-boarding a model.
