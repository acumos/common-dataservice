...
public interface ICommonDataServiceRestClient {
	...
	/**
	 * Searches for non-public, active solutions available to the specified peer by
	 * traversing the peer-group, peer-solution-group and solution-group membership
	 * mapping tables.
	 *
	 * @param peerId
	 * @param pageRequest
	 * @return Page of MLPSolution accessible to the specified peer, which may be none
	 */
