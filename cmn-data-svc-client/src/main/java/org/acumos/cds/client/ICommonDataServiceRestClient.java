...
public interface ICommonDataServiceRestClient {
	 ...
	 */
	MLPTaskStepResult getTaskStepResult(long taskId, long stepResultId);
	 ...
	 * @return Complete object, with generated information such as ID
	 */
	MLPTaskStepResult addTaskStepResult(MLPTaskStepResult stepResult);

	/**
	 * Updates a task step result.
	 * 
	 * @param stepResult
	 *                       Step Result data
	 */
