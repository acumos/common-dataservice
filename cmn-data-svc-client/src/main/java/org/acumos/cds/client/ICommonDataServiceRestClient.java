...
public interface ICommonDataServiceRestClient {
	 ...
	 * related records such as downloads, publish request and so on. The
	 * solution-revision in turn cascades the delete to artifacts and related
	 * records. Answers bad request if the ID is not known.
	 * 
	 * @param solutionId
	 *                       solution ID
	 */
