...
public interface ICommonDataServiceRestClient {
	...
	/**
	 * Maps the specified user to the specified workbench project.
	 * 
	 * @param projectId
	 *                      Project ID
	 * @param userId
	 *                      User ID
	 */
	void addProjectUserAccess(String projectId, String userId);

	/**
	 * Unmaps the specified user from the specified workbench project.
	 * 
	 * @param projectId
	 *                      Project ID
	 * @param userId
	 *                      User ID
	 */
	void dropProjectUserAccess(String projectId, String userId);
	...
	/**
	 * Gets the users mapped to the specified workbench project ID.
	 * 
	 * @param projectId
	 *                      Project ID.
	 * @return List of User objects; empty if none are found
	 */
	List<MLPUser> getProjectUsers(String projectId);
	...
	/**
	 * Gets a page of workbench notebooks accessible by the specified user, either
	 * directly or by access control list.
	 * 
	 * @param userId
	 *                        User ID
	 * @param pageRequest
	 ...
	 * @return Page of workbench notebook objects.
	 */
	RestPageResponse<MLPNotebook> getUserNotebooks(String userId, RestPageRequest pageRequest);
	...
	/**
	 * Maps the specified user to the specified workbench notebook.
	 * 
	 * @param notebookId
	 *                       Notebook ID
	 * @param userId
	 *                       User ID
	 */
	void addNotebookUserAccess(String notebookId, String userId);

	/**
	 * Unmaps the specified user from the specified workbench notebook.
	 * 
	 * @param notebookId
	 *                       Notebook ID
	 * @param userId
	 *                       User ID
	 */
	void dropNotebookUserAccess(String notebookId, String userId);
	...
	/**
	 * Gets a page of workbench pipelines accessible by the specified user, either
	 * directly or by access control list.
	 * 
	 * @param userId
	 *                        User ID
	 ...
	 * @return Page of workbench pipeline objects.
	 */
	RestPageResponse<MLPPipeline> getUserPipelines(String userId, RestPageRequest pageRequest);
	...
	/**
	 * Maps the specified user to the specified workbench pipeline.
	 * 
	 * @param pipelineId
	 *                       Pipeline ID
	 * @param userId
	 *                       User ID
	 */
	void addPipelineUserAccess(String pipelineId, String userId);

	/**
	 * Unmaps the specified user from the specified workbench pipeline.
	 * 
	 * @param pipelineId
	 *                       Pipeline ID
	 * @param userId
	 *                       User ID
	 */
	void dropPipelineUserAccess(String pipelineId, String userId);
