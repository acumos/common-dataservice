...
public interface ICommonDataServiceRestClient {
	 ...
	 * delay on repeated failures. Does NOT check the expiration date of the
	 ...
	 * match. Imposes a delay on repeated failures. This does NOT check the
