...
public class CommonDataServiceRestClientImpl implements ICommonDataServiceRestClient {
	...
	public MLPRevisionDescription getRevisionDescription(String revisionId, String accessTypeCode) {
		URI uri = buildUri(
				new String[] { CCDSConstants.REVISION_PATH, revisionId, CCDSConstants.ACCESS_PATH, accessTypeCode, CCDSConstants.DESCRIPTION_PATH }, null,
				null);
	...
	public MLPRevisionDescription createRevisionDescription(MLPRevisionDescription description) {
		URI uri = buildUri(
				new String[] { CCDSConstants.REVISION_PATH, description.getRevisionId(), CCDSConstants.ACCESS_PATH, description.getAccessTypeCode(), CCDSConstants.DESCRIPTION_PATH }, null,
				null);
