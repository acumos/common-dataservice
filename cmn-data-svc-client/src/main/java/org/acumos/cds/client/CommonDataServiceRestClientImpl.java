...
public class CommonDataServiceRestClientImpl implements ICommonDataServiceRestClient {
	...
	public List<MLPComment> getThreadComments(String threadId) {
		...
		ResponseEntity<List<MLPComment>> response = restTemplate.exchange(uri, HttpMethod.GET, null,
				new ParameterizedTypeReference<List<MLPComment>>() {
				});
		return response.getBody();
	}
