...
public class CommonDataServiceRestClientImpl implements ICommonDataServiceRestClient {
	...
	public void updateSiteConfig(MLPSiteConfig config) {
		URI uri = buildUri(new String[] { CCDSConstants.SITE_PATH,CCDSConstants.CONFIG_PATH, config.getConfigKey() }, null, null);
	...
	public MLPSiteContent getSiteContent(String contentKey) {
		URI uri = buildUri(new String[] { CCDSConstants.SITE_PATH, CCDSConstants.CONTENT_PATH, contentKey }, null, null);
	...
	public void updateSiteContent(MLPSiteContent config) {
		URI uri = buildUri(new String[] { CCDSConstants.SITE_PATH,CCDSConstants.CONTENT_PATH, config.getContentKey() }, null, null);
