...
public class CommonDataServiceRestClientImpl implements ICommonDataServiceRestClient {
	...
	// TODO
	// @Override
	// public RestPageResponse<MLPSolution> findSolutionsByModifiedDate(Date date,
	// RestPageRequest pageRequest) {
	// HashMap<String, Object> parms = new HashMap<>();
	// parms.put(CCDSConstants.DATE_PATH, new Long(date.getTime()));
	// URI uri = buildUri(
	// new String[] { CCDSConstants.SOLUTION_PATH, CCDSConstants.SEARCH_PATH,
	// CCDSConstants.DATE_PATH }, parms,
	// pageRequest);
	// logger.debug("findSolutionsByUpdateDate: uri {}", uri);
	// ResponseEntity<RestPageResponse<MLPSolution>> response =
