...
public class CommonDataServiceRestClientImpl implements ICommonDataServiceRestClient {
	...
	public long getThreadCount() {
		URI uri = buildUri(
				new String[] { CCDSConstants.COMMENT_PATH, CCDSConstants.THREAD_PATH, CCDSConstants.COUNT_PATH }, null,
				null);
	...
	public RestPageResponse<MLPThread> getThreads(RestPageRequest pageRequest) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH, CCDSConstants.THREAD_PATH }, null, pageRequest);
	...
	public MLPThread getThread(String threadId) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH, CCDSConstants.THREAD_PATH, threadId }, null,
				null);
	...
	public MLPThread createThread(MLPThread thread) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH, CCDSConstants.THREAD_PATH }, null, null);
	...
	public void updateThread(MLPThread thread) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH, CCDSConstants.THREAD_PATH, thread.getThreadId() },
				null, null);
	...
	public long getCommentCount(String threadId) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH, CCDSConstants.COUNT_PATH }, null, null);
	...
	public List<CommentTransport> getComments(String threadId) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH, CCDSConstants.THREAD_PATH, threadId }, null,
				null);
		logger.debug("getComments: uri {}", uri);
		ResponseEntity<List<CommentTransport>> response = restTemplate.exchange(uri, HttpMethod.GET, null,
				new ParameterizedTypeReference<List<CommentTransport>>() {
				});
		return response.getBody();
	}

	public MLPComment getComment(String commentId) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH, CCDSConstants.THREAD_PATH, commentId }, null,
				null);
		logger.debug("getThread: uri {}", uri);
	...
	public MLPComment createComment(MLPComment comment) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH }, null, null);
	...
	public void updateComment(MLPComment comment) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH, comment.getCommentId() }, null, null);
		logger.debug("updateComment: url {}", uri);
		restTemplate.put(uri, comment);
	}

	public void deleteComment(String commentId) {
		URI uri = buildUri(new String[] { CCDSConstants.COMMENT_PATH, commentId }, null, null);
