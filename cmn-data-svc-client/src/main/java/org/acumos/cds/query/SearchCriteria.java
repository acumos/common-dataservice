...
/**
 * Supports a tiny REST-friendly query language. Builds or parses a complex
 * query criteria that's usable as a GET request parameter. Might only have a
 * single criterion. Avoid characters '?', '=' and '&'.
 */
public class SearchCriteria {
	...
	/**
	 * Creates a list of criteria by parsing the string. For example: "a:b;|c_e,f".
	 * 
