...
public class MLPUser extends MLPTimestampedEntity implements Serializable {
	...
	/**
	 * Client sends date-time as long integer, milliseconds since the Epoch. Stored as
	 * DATETIME, but Derby lacks DATETIME, so do not specify column definition here.
	 */
