...
public class MLPRightToUse extends MLPTimestampedEntity implements Serializable {
	...
	@Column(name = "LUM_ID", nullable = false, columnDefinition = "CHAR(36)")
	@Size(max = 36)
	 ...
	 * 
	 * @param lumId
	 *                       License User Manager ID
	 * @param solutionId
	 *                       Solution ID
	 * @param site
	 *                       True if site-wide
	 */
	public MLPRightToUse(String lumId, String solutionId, boolean site) {
		if (lumId == null || solutionId == null)
	...
	public void setLumId(String lumId) {
		this.lumId = lumId;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(rtuId, lumId, solutionId);
	}
	...
	public String toString() {
		return this.getClass().getName() + "[rtuId=" + rtuId + ", lumId=" + lumId + ", solutionId=" + solutionId
