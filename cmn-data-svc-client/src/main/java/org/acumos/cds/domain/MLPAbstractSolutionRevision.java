 ...
 * user column is not mapped here; that is a reference to an MLPUser entity ID,
...
public abstract class MLPAbstractSolutionRevision extends MLPTimestampedEntity {
	...
	/**
	 * Lightly structured text with author (name, contact) pairs
	 */
	...
	private final String AUTHOR_ROW_SEP = "|";
	private final String AUTHOR_ROW_REGEX = "[" + AUTHOR_ROW_SEP + "]";
	/** author pair separator character */
	private final String AUTHOR_PAIR_SEP = "~";
	private final String AUTHOR_PAIR_REGEX = "[" + AUTHOR_PAIR_SEP + "]";
	 ...
	 * 
	 * @param authors
	 *            Set of author (name, contact) pairs. Must not use the character
	 *            {@link #AUTHOR_PAIR_SEP} nor {@link #AUTHOR_ROW_SEP}.
	 */
