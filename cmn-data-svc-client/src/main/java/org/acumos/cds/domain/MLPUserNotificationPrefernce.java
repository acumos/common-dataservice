...
public class MLPUserNotificationPrefernce implements MLPEntity, Serializable {
	 ...
	 * No-arg constructor.
	 */
	public MLPUserNotificationPrefernce() {
		// no-arg constructor
	}
	...
	public MLPUserNotificationPrefernce(String userId, String notfDelvMechCode, String msgSeverityCode) {
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (!(that instanceof MLPUserNotificationPrefernce))
			return false;
		MLPUserNotificationPrefernce thatObj = (MLPUserNotificationPrefernce) that;
