...
public abstract class MLPAbstractWorkbenchArtifact extends MLPTimestampedEntity {
	...
	@Size(max = 512)
	@ApiModelProperty(value = "URL of the storage repository", example = "http://my.company.com/repo/pipeline1")
	private String repositoryUrl;

	@Column(name = "SERVICE_URL", columnDefinition = "VARCHAR(512)")
	@Size(max = 512)
	@ApiModelProperty(value = "URL of the running service", example = "http://my.company.com/svc/pipeline1")
	 ...
	 *                   ID of a valid user
	 */
	public MLPAbstractWorkbenchArtifact(String name, boolean active, String userId) {
