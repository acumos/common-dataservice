...
import org.acumos.cds.domain.MLPPipelineUserAccMap.PlUserAccMap;
 ...
 */
@Entity
@IdClass(PlUserAccMap.class)
@Table(name = "C_PL_USER_ACC_MAP")
public class MLPPipelineUserAccMap implements MLPDomainModel, Serializable {
	 ...
	 */
	@Embeddable
	public static class PlUserAccMap implements Serializable {
		 ...
		 *                   project ID
		 */
		public PlUserAccMap(String userId, String projId) {
			this.userId = userId;
		...
		public boolean equals(Object that) {
			if (that == null)
				return false;
			if (!(that instanceof PlUserAccMap))
				return false;
			PlUserAccMap thatPK = (PlUserAccMap) that;
	 ...
	 *                   pipeline ID
	 */
	public MLPPipelineUserAccMap(String userId, String plId) {
	 ...
	 *                 Instance to copy
	 */
	public MLPPipelineUserAccMap(MLPPipelineUserAccMap that) {
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (!(that instanceof MLPPipelineUserAccMap))
			return false;
		MLPPipelineUserAccMap thatObj = (MLPPipelineUserAccMap) that;
