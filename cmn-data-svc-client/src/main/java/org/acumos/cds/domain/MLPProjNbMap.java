...
import org.acumos.cds.domain.MLPProjNbMap.ProjNbMapPK;
...
public class MLPProjNbMap implements MLPDomainModel, Serializable {
	...
	public static class ProjNbMapPK implements Serializable {
		...
		public boolean equals(Object that) {
			...
			return Objects.equals(projId, thatPK.projId) && Objects.equals(nbId, thatPK.nbId);
		}

		@Override
		public int hashCode() {
			return Objects.hash(projId, nbId);
		}
	 ...
	 *                   notebook ID
	 */
	public MLPProjNbMap(String projId, String nbId) {
	 ...
	 *                 Instance to copy
	 */
	public MLPProjNbMap(MLPProjNbMap that) {
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (!(that instanceof MLPProjNbMap))
			return false;
		MLPProjNbMap thatObj = (MLPProjNbMap) that;
		return Objects.equals(projId, thatObj.projId) && Objects.equals(nbId, thatObj.nbId);
	}
	...
	public String toString() {
		return this.getClass().getName() + "[projId=" + projId + ", nbId=" + nbId + "]";
	}
