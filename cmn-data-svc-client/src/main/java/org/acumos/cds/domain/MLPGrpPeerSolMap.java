 ...
 */
@Entity
@IdClass(MLPGrpPeerSolMap.GrpPeerSolMapPK.class)
@Table(name = MLPGrpPeerSolMap.TABLE_NAME)
public class MLPGrpPeerSolMap implements MLPEntity, Serializable {
	...
	/* package */ static final String TABLE_NAME = "C_GRP_PEER_SOL_MAP";
	 ...
	 */
	@Embeddable
	public static class GrpPeerSolMapPK implements Serializable {
		 ...
		 *            solution group ID
		 */
		public GrpPeerSolMapPK(Long peerGroupId, Long solGroupId) {
		...
		public boolean equals(Object that) {
			if (that == null)
				return false;
			if (!(that instanceof GrpPeerSolMapPK))
				return false;
			GrpPeerSolMapPK thatPK = (GrpPeerSolMapPK) that;
	...
	@Id
	@Column(name = MLPGrpPeerSolMap.PEER_GROUP_ID_COL_NAME, updatable = false, nullable = false, columnDefinition = "INT")
	private Long peerGroupId;

	@Id
	@Column(name = MLPGrpPeerSolMap.SOL_GROUP_ID_COL_NAME, updatable = false, nullable = false, columnDefinition = "INT")
	private Long solutionGroupId;
	 ...
	 *            solution group ID
	 */
	public MLPGrpPeerSolMap(Long peerGroupId, Long solGroupId) {
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (!(that instanceof MLPGrpPeerSolMap))
			return false;
		MLPGrpPeerSolMap thatObj = (MLPGrpPeerSolMap) that;
