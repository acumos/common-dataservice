 ...
 */
@Entity
@IdClass(MLPGrpSolMap.GrpSolMapPK.class)
@Table(name = MLPGrpSolMap.TABLE_NAME)
public class MLPGrpSolMap implements MLPEntity, Serializable {
	...
	/* package */ static final String TABLE_NAME = "C_GRP_SOL_MAP";
	 ...
	 */
	@Embeddable
	public static class GrpSolMapPK implements Serializable {
		 ...
		 *            solution ID
		 */
		public GrpSolMapPK(Long groupId, String solutionId) {
		...
		public boolean equals(Object that) {
			if (that == null)
				return false;
			if (!(that instanceof GrpSolMapPK))
				return false;
			GrpSolMapPK thatPK = (GrpSolMapPK) that;
	...
	@Id
	@Column(name = MLPGrpSolMap.GRP_ID_COL_NAME, updatable = false, nullable = false, columnDefinition = "INT")
	private Long groupId;

	@Id
	@Column(name = MLPGrpSolMap.SOL_ID_COL_NAME, updatable = false, nullable = false, columnDefinition = "CHAR(36)")
	@Size(max = 36)
	private String solutionId;
	 ...
	 *            solution ID
	 */
	public MLPGrpSolMap(Long groupId, String solutionId) {
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (!(that instanceof MLPGrpSolMap))
			return false;
		MLPGrpSolMap thatObj = (MLPGrpSolMap) that;
