...
public class MLPUserPlMap implements MLPDomainModel, Serializable {
	...
	public static class UserPlMapPK implements Serializable {
		...
		public boolean equals(Object that) {
			...
			return Objects.equals(plId, thatPK.plId) && Objects.equals(userId, thatPK.userId);
		}

		@Override
		public int hashCode() {
			return Objects.hash(plId, userId);
		}
	...
	public boolean equals(Object that) {
		...
		return Objects.equals(plId, thatObj.plId) && Objects.equals(userId, thatObj.userId);
	}
	...
	public String toString() {
		return this.getClass().getName() + "[userId=" + userId + ", plId=" + plId + "]";
	}
