...
import org.acumos.cds.domain.MLPUserPipelineMap.UserPlMapPK;
...
public class MLPUserPipelineMap implements MLPDomainModel, Serializable {
	 ...
	 *                   pipeline ID
	 */
	public MLPUserPipelineMap(String userId, String plId) {
	 ...
	 *                 Instance to copy
	 */
	public MLPUserPipelineMap(MLPUserPipelineMap that) {
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (!(that instanceof MLPUserPipelineMap))
			return false;
		MLPUserPipelineMap thatObj = (MLPUserPipelineMap) that;
