...
public class MLPTask extends MLPTimestampedEntity implements Serializable {
	 ...
	 *                       Status code
	 */
	public MLPTask(String name, String userId, String statusCode) {
		if (name == null || userId == null || statusCode == null)
	...
	public String toString() {
		return this.getClass().getName() + "[trackingId=" + trackingId + ", " + ", userId=" + userId + "name=" + name
