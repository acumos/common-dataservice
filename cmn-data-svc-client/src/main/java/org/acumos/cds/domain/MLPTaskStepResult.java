...
public class MLPTaskStepResult implements MLPDomainModel, Serializable {
	...
	public String toString() {
		return this.getClass().getName() + "[stepResultId=" + stepResultId + "solutionId=" + solutionId + "artifactId="
				+ artifactId + "name=" + name + "statusCode=" + statusCode + "result=" + result + ", startDate="
