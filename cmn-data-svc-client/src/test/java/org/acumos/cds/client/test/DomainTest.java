...
public class DomainTest extends AbstractModelTest {
	...
	public void testMLPNotebook() {
		MLPNotebook m = new MLPNotebook(s1, s1);
		m = new MLPNotebook();
		m.setCreated(t1);
		m.setDescription(s1);
	...
	public void testMLPPipeline() {
		MLPPipeline m = new MLPPipeline(s1, s1);
		m = new MLPPipeline();
		m.setCreated(t1);
		m.setDescription(s1);
		m.setModified(t2);
	...
	public void testMLPProject() {
		MLPProject m = new MLPProject(s1, s1);
		m = new MLPProject();
		m.setCreated(t1);
		m.setDescription(s1);
		m.setModified(t2);
