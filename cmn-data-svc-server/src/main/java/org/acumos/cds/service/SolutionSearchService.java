...
public interface SolutionSearchService {
	...
	/**
	 * Gets a page of private user-accessible solutions. This includes the user's
	 * own private solutions as well as solutions shared with the user via the
	 ...
	 * @return Page of matches
	 */
	public Page<MLPSolution> findUserPrivateSolutions(String[] nameKeywords, String[] descriptionKeywords,
			boolean active, String userId, String[] modelTypeCode, String[] validationStatusCode, String[] tags,
			Pageable pageable);
