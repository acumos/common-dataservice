...
public class TaskSearchServiceImpl extends AbstractSearchServiceImpl implements TaskSearchService {
	...
	private Predicate createTaskPredicate(Root<MLPTask> from, Long taskId, String taskCode, String name,
			String statusCode, String trackingId, String userId, boolean isOr) {
	 ...
	 */
	@Override
	public Page<MLPTask> findTasks(Long taskId, String taskCode, String name, String statusCode, String trackingId,
		...
		countQueryDef
				.where(createTaskPredicate(countFrom, taskId, taskCode, name, statusCode, trackingId, userId, isOr));
