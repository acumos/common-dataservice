...
public class TaskSearchServiceImpl extends AbstractSearchServiceImpl implements TaskSearchService {
	 ...
	 * @return Predicate
	 */
	private Predicate createTaskPredicate(Root<MLPTask> from, Long taskId, String taskCode, String name, String statusCode,
	 ...
	 */
	@Override
	public Page<MLPTask> findTasks(Long taskId, String taskCode, String name, String statusCode, String trackingId, String userId,
		...
		countQueryDef.where(createTaskPredicate(countFrom, taskId, taskCode, name, statusCode, trackingId, userId, isOr));
		...
		rootQueryDef.where(createTaskPredicate(countFrom, taskId, taskCode, name, statusCode, trackingId, userId, isOr));
