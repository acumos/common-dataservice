...
public class PublishRequestSearchServiceImpl extends AbstractSearchServiceImpl implements PublishRequestSearchService {
	...
	@Override
	public Page<MLPPublishRequest> findPublishRequests(Map<String, Object> queryParameters, boolean isOr,
			Pageable pageable) {

		try (Session session = getSessionFactory().openSession()) {
			Criteria criteria = session.createCriteria(MLPPublishRequest.class);
