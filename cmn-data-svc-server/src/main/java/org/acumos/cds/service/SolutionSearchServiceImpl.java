...
public class SolutionSearchServiceImpl extends AbstractSearchServiceImpl implements SolutionSearchService {
	...
	@Override
	public Page<MLPSolution> findSolutionsByModifiedDate(boolean active, String[] accessTypeCodes, Date date,
			Pageable pageable) {
		...
		Predicate solMod = cb.greaterThanOrEqualTo(solutionFom.<Date>get(MLPSolutionFOM_.modified), date);
		Predicate revMod = cb.greaterThanOrEqualTo(revFom.<Date>get(MLPSolutionRevisionFOM_.modified), date);
		Predicate artMod = cb.greaterThanOrEqualTo(revArtFom.<Date>get(MLPArtifactFOM_.modified), date);
		Predicate descMod = cb.greaterThanOrEqualTo(revDesc.<Date>get(MLPRevisionDescription_.modified), date);
		Predicate docMod = cb.greaterThanOrEqualTo(revDoc.<Date>get(MLPDocument_.modified), date);
