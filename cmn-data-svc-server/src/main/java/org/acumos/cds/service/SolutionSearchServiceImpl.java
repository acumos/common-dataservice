...
public class SolutionSearchServiceImpl extends AbstractSearchServiceImpl implements SolutionSearchService {
	...
	public Page<MLPSolution> findPortalSolutionsByKw(String[] keywords, boolean active, String[] userIds,
		...
		if (keywords != null && keywords.length > 0) {
			...
			keywordDisjunction.add(buildLikeListCriterion("name", keywords, true));
			keywordDisjunction.add(buildLikeListCriterion(descsAlias + ".description", keywords, true));
			keywordDisjunction.add(buildLikeListCriterion(revAlias + ".authors", keywords, true));
			keywordDisjunction.add(buildLikeListCriterion(revAlias + ".publisher", keywords, true));
