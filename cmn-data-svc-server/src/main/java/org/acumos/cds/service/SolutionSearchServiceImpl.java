...
public class SolutionSearchServiceImpl extends AbstractSearchServiceImpl implements SolutionSearchService {
	...
	/**
	 * Builds a disjunction ("OR") criterion to check exact match of any value in the list, with
	...
	/**
	 * Builds a disjunction ("OR") criterion to check approximate match of any value in the list;
	...
	@SuppressWarnings("unchecked")
	@Override
	public Page<MLPSolution> findPortalSolutions(String [] nameKeywords, String [] descKeywords, String [] authorKeywords,
		...
		if (authorKeywords != null && authorKeywords.length > 0) {
			// TODO
			logger.error("findPortalSolutions: Author not implemented");
		}
