...
public class SolutionSearchServiceImpl extends AbstractSearchServiceImpl implements SolutionSearchService {
	...
	@SuppressWarnings("unchecked")
	public Page<MLPSolution> findSolutionsByModifiedDate(boolean active, String[] accessTypeCodes,
			String[] valStatusCodes, Date date, Pageable pageable) {
		...
		if (accessTypeCodes != null && accessTypeCodes.length > 0)
			solCriteria.add(Restrictions.in(revAlias + ".accessTypeCode", accessTypeCodes));
