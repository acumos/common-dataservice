...
public class MLPSolutionRevisionFOM extends MLPAbstractSolutionRevision implements Serializable {
	...
	@JoinTable(name = MLPSolRevArtMap.TABLE_NAME, joinColumns = {
			@JoinColumn(name = MLPSolRevArtMap.REVISION_ID_COL_NAME) }, inverseJoinColumns = {
					@JoinColumn(name = MLPSolRevArtMap.ARTIFACT_ID_COL_NAME) })
