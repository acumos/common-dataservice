...
public class MLPSolutionRevisionFOM extends MLPAbstractSolutionRevision implements Serializable {
    ...
    @JoinTable(
        name = MLPSolRevArtMap.TABLE_NAME, 
	...
	public String toString() {
		return this.getClass().getName() + "[revisionId=" + getRevisionId() + ", owner="
				+ owner + ", meta=" + getMetadata() + ", version=" + getVersion() + ", artifacts=" + artifacts + ", created=" + getCreated()
	...
	public MLPSolutionRevision toMLPSolutionRevision() {
		MLPSolutionRevision rev = new MLPSolutionRevision(solution.getSolutionId(), getVersion(), owner.getUserId(), getAccessTypeCode());
