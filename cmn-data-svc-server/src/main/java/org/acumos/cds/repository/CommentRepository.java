...
public interface CommentRepository extends PagingAndSortingRepository<MLPComment, String> {
	...
	/**
	 * Gets all comments with the specified thread ID using Spring magic.
	 * 
	 * @param threadId
	 *            Thread ID
	 * @return List of MLPComment, sorted by created date-time.
	 */
	List<MLPComment> findByThreadIdOrderByCreated(String threadId);
