...
public interface GrpPeerSolMapRepository extends PagingAndSortingRepository<MLPGrpPeerSolMap, MLPGrpPeerSolMap.GrpPeerSolMapPK> {
	...
	@Query(value = "DELETE FROM MLPGrpPeerSolMap m " //
