...
public interface SolutionRepository extends JpaRepository<MLPSolution, String>, JpaSpecificationExecutor<MLPSolution> {
	...
	/**
	 * Searches for restricted (non-public), active solutions accessible to the
	 * specified peer by traversing the peer group and solution group membership
	 * mapping tables.
	 * 
