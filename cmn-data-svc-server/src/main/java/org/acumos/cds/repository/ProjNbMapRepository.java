...
public interface ProjNbMapRepository extends CrudRepository<MLPProjNbMap, MLPProjNbMap.ProjNbMapPK> {
	 ...
	 */
	@Query(value = "select p from MLPNotebook p, MLPProjNbMap m " //
