...
public interface ProjPlMapRepository extends CrudRepository<MLPProjPlMap, MLPProjPlMap.ProjPlMapPK> {
	 ...
	 */
	@Query(value = "select p from MLPPipeline p, MLPProjPlMap m " //
