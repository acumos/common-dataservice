...
public interface UserNotebookMapRepository extends CrudRepository<MLPUserNotebookMap, MLPUserNotebookMap.UserNbMapPK> {
	 ...
	 */
	@Query(value = "select p from MLPNotebook p, MLPUserNotebookMap m " //
