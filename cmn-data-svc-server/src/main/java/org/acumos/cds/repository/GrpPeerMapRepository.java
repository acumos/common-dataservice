...
public interface GrpPeerMapRepository extends PagingAndSortingRepository<MLPGrpPeerMap, MLPGrpPeerMap.GrpPeerMapPK> {
	 ...
	 */
	@Query(value = "select p from MLPPeer p, MLPGrpPeerMap m " //
	...
	@Query(value = "DELETE FROM MLPGrpPeerMap m " //
