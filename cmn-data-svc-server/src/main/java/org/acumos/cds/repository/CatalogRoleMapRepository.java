...
public interface CatalogRoleMapRepository extends CrudRepository<MLPCatRoleMap, MLPCatRoleMap.CatalogRoleMapPK> {
	...
	/**
	 * Finds all map entries for the specified catalogId.
	 * 
