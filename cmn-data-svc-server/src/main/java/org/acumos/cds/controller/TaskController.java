...
public class TaskController extends AbstractController {
	...
	@ApiOperation(value = "Gets a task's step results. Answers empty if none are found.", //
			response = MLPStepResult.class, responseContainer = "List")
	@ApiPageable
	@RequestMapping(value = "/{taskId}/" + CCDSConstants.STEP_RESULT_PATH, method = RequestMethod.GET)
	public Iterable<MLPStepResult> getTaskStepResults(@PathVariable("taskId") Long taskId) {
	...
	public MLPStepResult getTaskStepResult(@PathVariable("stepResultId") Long stepResultId) {
	...
	public MLPResponse addTaskStepResult(@PathVariable("taskId") Long taskId, @RequestBody MLPStepResult stepResult,
			HttpServletResponse response) {
	...
	public MLPTransportModel updateTaskStepResult(@PathVariable("taskId") Long taskId,
			@PathVariable("stepResultId") Long stepResultId, @RequestBody MLPStepResult stepResult,
			HttpServletResponse response) {
