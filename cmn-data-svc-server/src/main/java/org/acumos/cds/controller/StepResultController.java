...
public class StepResultController extends AbstractController {
	 ...
	 */
	@ApiOperation(value = "Searches for step results using the field name - field value pairs specified as query parameters. Defaults to and (conjunction); send junction query parameter = o for or (disjunction).", response = MLPStepResult.class, responseContainer = "List")
