...
public class PeerController extends AbstractController {
	 ...
	 */
	private static final String peerIdField = "peerId";
	...
	public Object searchPeers( //
			...
			@ApiParam(value = "Peer ID") //
			@RequestParam(name = peerIdField, required = false) String peerId, //
			@ApiParam(value = "Name") //
		...
		if (peerId != null)
			queryParameters.put(peerIdField, peerId);
		if (name != null)
