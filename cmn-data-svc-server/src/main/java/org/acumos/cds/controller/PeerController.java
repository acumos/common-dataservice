...
public class PeerController extends AbstractController {
	 ...
	 */
	@ApiOperation(value = "Gets a list of peers matching the field name - field value pairs specified as query parameters. Defaults to and (conjunction); send junction query parameter = o for or (disunction).", response = MLPPeer.class, responseContainer = "List")
	@RequestMapping(value = "/" + CCDSConstants.SEARCH_PATH, method = RequestMethod.GET)
	@ResponseBody
	public Object searchPeers(@RequestParam MultiValueMap<String, String> queryParameters, HttpServletResponse response) {
		Object result;
		try {
