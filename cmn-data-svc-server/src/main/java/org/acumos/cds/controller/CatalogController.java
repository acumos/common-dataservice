...
public class CatalogController extends AbstractController {
	...
	public MLPTransportModel addCatalogRole(@PathVariable("catalogId") String catalogId, @PathVariable("roleId") String roleId,
			HttpServletResponse response) {
	...
	public MLPTransportModel updateCatalogRoles(@PathVariable("catalogId") String catalogId, @RequestBody List<String> roleIds,
			HttpServletResponse response) {
