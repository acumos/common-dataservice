...
public class CatalogController extends AbstractController {
	...
	@RequestMapping(value = CCDSConstants.PEER_PATH + "/{peerId}/" + CCDSConstants.IDS_PATH, method = RequestMethod.GET)
	...
	@ApiOperation(value = "Gets the list of catalog IDs that are favorites of the specified user; empty if none are found.", //
			response = String.class, responseContainer = "List")
	@RequestMapping(value = CCDSConstants.USER_PATH + "/{userId}/" + CCDSConstants.IDS_PATH, method = RequestMethod.GET)
	...
	@ApiOperation(value = "Marks the specified catalog as a favorite of the specified user. Answers bad request if an ID is invalid.", //
			response = SuccessTransport.class)
	@RequestMapping(value = "/{catalogId}/" + CCDSConstants.USER_PATH + "/{userId}", method = RequestMethod.POST)
	...
	@ApiOperation(value = "Unmarks the specified catalog as a favorite of the specified user.", //
			response = SuccessTransport.class)
	@ApiResponses({ @ApiResponse(code = 400, message = "Bad request", response = ErrorTransport.class) })
	@RequestMapping(value = "/{catalogId}/" + CCDSConstants.USER_PATH + "/{userId}", method = RequestMethod.DELETE)
