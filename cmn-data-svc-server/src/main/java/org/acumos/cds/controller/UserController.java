...
public class UserController extends AbstractController {
	...
	@ResponseBody
	public Iterable<MLPUserNotificationPrefernce> getNotificationPreferencesForUser(@PathVariable("userId") String userId, Pageable pageable) {
		return notificationpreferenceRepository.findByUser(userId, pageable);
	}
