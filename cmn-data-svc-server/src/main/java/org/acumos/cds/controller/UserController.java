...
public class UserController extends AbstractController {
	...
	/**
	 * @param user
	 *            User object to save. If no ID is set a new one will be
	 *            generated; if an ID value is set, it will be used if valid and
	 *            not in table.
	 * @param response
	 *            HttpServletResponse
	 ...
	 * @param pageable
	 *            Page request
	 * @return List of active notifications for the specified user, ignoring
	 *         viewed status
	 */
	...
	@ResponseBody
	public Iterable<MLPUserNotifPref> getNotificationPreferencesForUser(
	...
	/**
	 * @param usrNotifPref
	 *            user notification preference to save. A new one will be
	 *            generated;
	 * @param response
	 *            HttpServletResponse
	...
	@ResponseBody
	public Object createStepResult(@RequestBody MLPUserNotifPref usrNotifPref,
			HttpServletResponse response) {
