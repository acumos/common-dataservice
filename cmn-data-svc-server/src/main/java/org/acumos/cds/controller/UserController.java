...
public class UserController extends AbstractController {
	 ...
	 */
	@ApiOperation(value = "Searches for users that exactly match the field name - field value pairs specified as query parameters. Defaults to and (conjunction); send junction query parameter = o for or (disunction).", response = MLPUser.class, responseContainer = "List")
