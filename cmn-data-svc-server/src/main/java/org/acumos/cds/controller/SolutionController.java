...
public class SolutionController extends AbstractController {
	...
	public Object findPortalSolutions(@RequestParam Map<String, String> queryParameters, Pageable pageRequest,
		...
		try {
			...
			String [] authorKws = getOptCsvParameter(CCDSConstants.SEARCH_AUTHOR, queryParameters);
			...
			return solutionSearchService.findPortalSolutions(nameKws, descKws, authorKws, active, accessTypeCodes,
