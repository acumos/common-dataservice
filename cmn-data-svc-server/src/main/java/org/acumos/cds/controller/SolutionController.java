...
public class SolutionController extends AbstractController {
	...
	public Object saveSolutionImage(@PathVariable("solutionId") String solutionId, @RequestBody byte[] image,
			HttpServletResponse response) {
		logger.info("saveSolutionImage: ID {} length {}", solutionId, image.length);
