...
public class SolutionController extends AbstractController {
	...
	public Object findPortalSolutions( //
			...
			@ApiParam(value = "Access type codes", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_ACCESS_TYPES, required = false) String[] accTypeCodes, //
			@ApiParam(value = "Model type codes", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_MODEL_TYPES, required = false) String[] modelTypeCodes, //
			@ApiParam(value = "Validation status codes", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_VAL_STATUSES, required = false) String[] valStatusCodes, //
			@ApiParam(value = "User IDs", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_USERS, required = false) String[] userIds, //
			@ApiParam(value = "Tags", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_TAGS, required = false) String[] tags, //
			@ApiParam(value = "Name key words", allowMultiple = true, type = "Array[string]", required = false) //
			...
			@ApiParam(value = "Author key words", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_AUTH, required = false) String[] authKws, //
			@ApiParam(value = "Publisher key words", allowMultiple = true, type = "Array[string]", required = false) //
	...
	public Object findPortalSolutionsByKw( //
			...
			@ApiParam(value = "Model type codes", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_MODEL_TYPES, required = false) String[] modelTypeCodes, //
			@ApiParam(value = "Key words", allowMultiple = true, type = "Array[string]", required = false) //
	...
	public Object findUserSolutions( //
			...
			@ApiParam(value = "Name key words", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_NAME, required = false) String[] nameKws, //
			@ApiParam(value = "Description key words", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_DESC, required = false) String[] descKws, //
			@ApiParam(value = "Tags", allowMultiple = true, type = "Array[string]", required = false) //
			@RequestParam(name = CCDSConstants.SEARCH_TAGS, required = false) String[] tags, //
			Pageable pageRequest, HttpServletResponse response) {
	...
	public Object findSolutionsByDate( //
			...
			@ApiParam(value = "Active Y/N", required = false) //
