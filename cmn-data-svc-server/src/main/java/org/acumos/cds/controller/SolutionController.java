...
public class SolutionController extends AbstractController {
	 ...
	 * @return Page of solutions
	 */
	@ApiOperation(value = "Searches for solutions using the field name - field value pairs specified as query parameters. Defaults to and (conjunction); send junction query parameter = o for or (disunction).", response = MLPSolution.class, responseContainer = "Page")
