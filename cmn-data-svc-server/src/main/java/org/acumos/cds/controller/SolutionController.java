...
public class SolutionController extends AbstractController {
	...
	@ApiOperation(value = "Flexible search for entities with attribute values and/or child attribute values matching the field name - field value pairs specified as query parameters. " //
	...
	@ApiOperation(value = "Flexible search for entities with attribute values and/or child attribute values matching the field name - field value pairs specified as query parameters. " //
			+ "Checks multiple fields for the supplied keywords, including ID, name, description etc.", response = MLPSolution.class, responseContainer = "Page")
	@ApiPageable
	...
	@ApiOperation(value = "Searches for user-accessible solutions with attribute values matching the field name - field value pairs specified as query parameters. " //
			+ "Search is limited to solution attributes and tags; does not search any child entities.", //
			response = MLPSolution.class, responseContainer = "Page")
	@ApiPageable
	...
	@ApiOperation(value = "Searches for solutions with attribute values matching the field name - field value pairs specified as query parameters. " //
