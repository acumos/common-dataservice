...
public class ArtifactController extends AbstractController {
	 ...
	 * @return List of artifacts, for serialization as JSON
	 */
	@ApiOperation(value = "Gets a list of artifacts restricted by field name - field value pairs specified as query parameters. Defaults to and (conjunction); send junction query parameter = o for or (disunction).", response = MLPArtifact.class, responseContainer = "List")
	@RequestMapping(value = "/" + CCDSConstants.SEARCH_PATH, method = RequestMethod.GET)
	@ResponseBody
	public Object searchArtifacts(@RequestParam MultiValueMap<String, String> queryParameters, HttpServletResponse response) {
		Object result;
		try {
