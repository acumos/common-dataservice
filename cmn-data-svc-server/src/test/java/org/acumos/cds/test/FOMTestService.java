...
public class FOMTestService {
	...
	public void testFomAnnotations() {
		...
		CriteriaQuery<MLPSolutionFOM> queryDefSolFom = entityManager.getCriteriaBuilder().createQuery(MLPSolutionFOM.class);
		...
		CriteriaQuery<MLPSolutionRevision> queryDefRev = entityManager.getCriteriaBuilder().createQuery(MLPSolutionRevision.class);
		...
		CriteriaQuery<MLPSolutionRevisionFOM> queryDefRevFom = entityManager.getCriteriaBuilder().createQuery(MLPSolutionRevisionFOM.class);
		...
		CriteriaQuery<MLPArtifactFOM> queryDefArtFom = entityManager.getCriteriaBuilder().createQuery(MLPArtifactFOM.class);
