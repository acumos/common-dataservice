...
public class CdsControllerTest {
	...
	public void testErrorConditions() throws Exception {
		...
		try {
			csr = new MLPSolutionRevision(cs.getSolutionId(), s64, cu.getUserId(), "PB");
			client.createSolutionRevision(csr);
			throw new Exception("Unexpected success");
		} catch (HttpStatusCodeException ex) {
		...
		try {
			csr = new MLPSolutionRevision(cs.getSolutionId(), "v1", cu.getUserId(), "PB");
		...
		csr = new MLPSolutionRevision(cs.getSolutionId(), solRevVersion, cu.getUserId(), "PB");
