...
public class CdsControllerTest {
	...
	public void testTaskStepResult() throws Exception {
		...
		try {
			...
			sr = new MLPTaskStepResult(ct.getTaskId(), stepName, "SU", Instant.now().minusSeconds(60));
			sr = client.createTaskStepResult(sr);
			...
			MLPTaskStepResult getById = client.getTaskStepResult(sr.getStepResultId());
		...
		client.deleteTaskStepResult(sr.getStepResultId());
