...
public class CdsControllerTest {
	...
	public void createSolutionWithArtifacts() throws Exception {
		...
		try {
			...
			logger.info("Logged in successfully via token");
			...
			pr.setLicenseStatusCode("IP");
			pr.setVulnerabilityStatusCode("IP");
	...
	public void testErrorConditions() throws Exception {
		...
		try {
			...
			client.findPortalSolutions(null, null, true, null, null, null, searchTags, null, null, new RestPageRequest(0, 1));
