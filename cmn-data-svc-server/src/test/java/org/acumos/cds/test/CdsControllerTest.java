...
public class CdsControllerTest {
	...
	public void testUserNotificationPreferences() throws Exception {
		...
		//	Assert.assertTrue(client.getUserNotificationPreference(usrNotifPref.getUserNotifPrefId()).getNotfDelvMechCode().equals(NotificationDeliveryMechanismTypeCode.EM));
			...
			RestPageResponse<MLPUserNotificationPrefernce> usrNotifPrefs = client.getUserNotificationPreferences(cu.getUserId(), null);
			...
			Iterable<MLPUserNotificationPrefernce> allusrNotifPrefs = client.getAllUserNotificationPreferences(null);
			Assert.assertTrue(allusrNotifPrefs.iterator().hasNext());
			logger.info("First user notification preference{}", allusrNotifPrefs.iterator().next());
