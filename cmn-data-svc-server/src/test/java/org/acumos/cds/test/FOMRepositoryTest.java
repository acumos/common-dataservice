...
public class FOMRepositoryTest {
	...
	public void testEntities() throws Exception {
		...
		logger.info("Querying for SolFOM by user");
		Page<MLPSolutionFOM> pubPage = solutionFOMRepository.findPublishedByUser(cu.getUserId(), pageable);
		Assert.assertNotNull(pubPage);
		Assert.assertNotEquals(0, pubPage.getNumberOfElements());
