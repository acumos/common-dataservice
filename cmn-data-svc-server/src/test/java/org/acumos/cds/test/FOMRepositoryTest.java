...
public class FOMRepositoryTest {
	...
	public void testEntities() throws Exception {
		...
		final String accCode = "PR";
		final String valCode = "NV";
		...
		Page<MLPSolution> byName = solutionSearchService.findPortalSolutions(nameKw, empty, true, empty, 
				empty, accTypes, valCodes, empty, pageable);
