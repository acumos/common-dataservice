...
public class FOMRepositoryTest {
	...
	public void testEntities() throws Exception {
		...
		logger.info("Querying for FOM via repo");
		...
		Page<MLPSolution> solsBySql = solutionRepository.findByModifiedDate(true, accTypes, valCodes,
		...
		Page<MLPSolution> solsByDate = solutionSearchService.findSolutionsByModifiedDate(true, accTypes, valCodes,
				modifiedDate, new PageRequest(0, 5, null));
		//TODO Assert.assertTrue(solsByDate != null && solsByDate.getNumberOfElements() > 0);
