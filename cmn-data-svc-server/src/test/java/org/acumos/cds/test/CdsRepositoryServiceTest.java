...
public class CdsRepositoryServiceTest {
	...
	public void testTaskStepResults() throws Exception {
		try {
			...
			MLPTaskStepResult sr = new MLPTaskStepResult(st.getTaskId(), "OB", "solution ID creation", statusCode,
			...
			Page<MLPTaskStepResult> page = stepResultSearchService.findStepResults(null, null, null, null, null, null,
