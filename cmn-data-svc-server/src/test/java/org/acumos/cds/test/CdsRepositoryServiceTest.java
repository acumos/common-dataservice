	...
	public void testRepositories() throws Exception {
		...
		try {
			...
			Page<MLPSolution> recentlyUpdated = solutionSearchService.findSolutionsByModifiedDate(true, accTypes,
					justAboutNow, PageRequest.of(0, 5));
			...
			Page<MLPSolution> solsByModDate = solutionSearchService.findSolutionsByModifiedDate(true, accessTypes,
					anHourAgo, PageRequest.of(0, 5));
			logger.info("Solutions by date: {}", solsByModDate);
			Assert.assertFalse(solsByModDate.getContent().isEmpty());
