...
CREATE TABLE C_USER (
  ...
  UNIQUE INDEX C_USER_C_ORG_NAME (ORG_NAME)
...
CREATE TABLE C_PEER (
  ...
  CREATED_DATE TIMESTAMP NOT NULL DEFAULT 0,
  MODIFIED_DATE TIMESTAMP NOT NULL,  
  UNIQUE INDEX C_PEER_C_SUBJECT_NAME (SUBJECT_NAME)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE C_USER_LOGIN_PROVIDER (
  ...
  CREATED_DATE TIMESTAMP NOT NULL DEFAULT 0,
  MODIFIED_DATE TIMESTAMP NOT NULL,
  UNIQUE INDEX C_USER_LOGIN_PROVIDER_C_PROFILE_URL (PROFILE_URL),
...
CREATE TABLE C_NOTIFICATION (
  ...
  CREATED_DATE TIMESTAMP NOT NULL DEFAULT 0,
  MODIFIED_DATE TIMESTAMP NOT NULL,
  UNIQUE INDEX C_NOTIFICATION_C_TITLE (TITLE)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE C_THREAD (
  ...
  REVISION_ID CHAR(36) NOT NULL,
  TITLE VARCHAR(128),
  UNIQUE INDEX C_THREAD_C_TITLE (TITLE)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
