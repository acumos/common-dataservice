...
CREATE TABLE C_LICENSE_PROFILE (
  LICENSE_ID VARCHAR(50) NOT NULL PRIMARY KEY,
  LICENSE VARCHAR(8192) NOT NULL CHECK (JSON_VALID(LICENSE)),
  PRIORITY INT NOT NULL,
  USER_ID CHAR(36) NOT NULL,
  CREATED_DATE TIMESTAMP NOT NULL DEFAULT 0,
  MODIFIED_DATE TIMESTAMP NOT NULL,
  CONSTRAINT C_LICENSE_PROFILE_C_USER FOREIGN KEY (USER_ID) REFERENCES C_USER (USER_ID)
