...
SELECT distinct 'rrrrrrrr-rrrr-rrrr-rrrr-rrrrrrrrrrrr', solution_id, NOW() FROM c_solution_rev WHERE solution_id NOT IN
(SELECT solution_id FROM c_solution_rev WHERE access_type_cd  IN ('PB','PR'));
...
INSERT INTO c_cat_sol_map (CATALOG_ID, SOLUTION_ID, CREATED_DATE)
SELECT distinct 'pppppppp-pppp-pppp-pppp-pppppppppppp', solution_id, NOW() FROM c_solution_rev WHERE solution_id NOT IN
