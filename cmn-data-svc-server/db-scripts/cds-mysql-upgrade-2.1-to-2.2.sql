...
INSERT INTO C_CATALOG (CATALOG_ID, ACCESS_TYPE_CD, NAME, PUBLISHER, URL, CREATED_DATE, MODIFIED_DATE) 
  VALUES ('12345678-efgh-90cd-ghij-1234567890cd', 'RS', 'Site-Instance-Name-Restricted', 'Another publisher', 'http://localhost', NOW(), NOW());
...
SELECT '12345678-efgh-90cd-ghij-1234567890cd', REVISION_ID, DESCRIPTION, CREATED_DATE, MODIFIED_DATE
FROM c_revision_desc WHERE ACCESS_TYPE_CD = 'OR'; 

INSERT INTO c_cat_sol_map (CATALOG_ID, SOLUTION_ID)
SELECT distinct '12345678-efgh-90cd-ghij-1234567890cd', solution_id FROM c_solution_rev WHERE solution_id NOT IN
...
SELECT '12345678-efgh-90cd-ghij-1234567890cd', REVISION_ID, DOCUMENT_ID
