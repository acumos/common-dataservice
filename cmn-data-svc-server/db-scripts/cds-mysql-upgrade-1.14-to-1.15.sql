...
-- WARNING!!  THIS SCRIPT ADDS UNIQUE CONSTRAINTS TO C_ROLE, C_PEER_GROUP and C_SOLUTION_GROUP. IF ANY OF THE FOLLOWING SELECTS RETURNS
-- A RECORD THEN THE UNIQUE CONSTRAINT CREATION WILL FAIL, FAILING THE SCRIPT. IN THAT CASE DELETE THE EXISTING RECORDS IN DATABASE WITH 
-- DUPLICATE ROLE NAME AND/OR PEER GROUP NAME AND/OR SOLUTION GROUP NAME UNTIL THERE EXISTS AT MOST ONE RECORD WITH THAT ROLE NAME AND/OR PEER GROUP NAME AND/OR SOLUTION GROUP NAME AND 
-- RERUN THE SCRIPT
-- 0
