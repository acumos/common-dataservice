...
-- 7
CREATE UNIQUE INDEX C_USER_C_ORG_NAME ON C_USER (ORG_NAME);  
-- 8
CREATE UNIQUE INDEX C_ROLE_C_NAME ON C_ROLE (NAME);  
-- 9
CREATE UNIQUE INDEX C_USER_LOGIN_PROVIDER_C_PROFILE_URL ON C_USER_LOGIN_PROVIDER (PROFILE_URL);
-- 10
CREATE UNIQUE INDEX C_NOTIFICATION_C_TITLE ON C_NOTIFICATION (TITLE );  
-- 11
