-- DDL and DML for tables managed by the Common Data Service version 1.12.x
...
CREATE TABLE C_SOLUTION (
  ...
  CONSTRAINT C_SOLUTION_C_PEER FOREIGN KEY (PEER_ID) REFERENCES C_PEER (PEER_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
