...
CREATE TABLE C_MESSAGE_SEVERITY_TYPE (
  TYPE_CD CHAR(2) NOT NULL PRIMARY KEY,
  TYPE_NAME VARCHAR(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE NOTIF_DELV_MECH_TYPE (
  TYPE_CD CHAR(2) NOT NULL PRIMARY KEY,
  TYPE_NAME VARCHAR(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE C_NOTIFICATION (
  ...
  CREATED_DATE TIMESTAMP NOT NULL,
  MODIFIED_DATE TIMESTAMP NOT NULL,
  CONSTRAINT C_NOTIFICATION_MSG_SEVERITY_CD FOREIGN KEY (MSG_SEVERITY_CD) REFERENCES C_MESSAGE_SEVERITY_TYPE (TYPE_CD)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE C_NOTIF_USER_PREF (
  ...
  CONSTRAINT C_NOTIF_USER_PREF_NOTIF_DELV_MECH_CD FOREIGN KEY (NOTIF_DELV_MECH_CD) REFERENCES NOTIF_DELV_MECH_TYPE (TYPE_CD),
  CONSTRAINT C_NOTIF_USER_PREF_MSG_SEVERITY_CD FOREIGN KEY (MSG_SEVERITY_CD) REFERENCES C_MESSAGE_SEVERITY_TYPE (TYPE_CD)	
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
# Also see enum MessageSeverityTypeCode
INSERT INTO C_MESSAGE_SEVERITY_TYPE (TYPE_CD, TYPE_NAME) VALUES ('HI', 'High');
INSERT INTO C_MESSAGE_SEVERITY_TYPE (TYPE_CD, TYPE_NAME) VALUES ('ME', 'Medium');
INSERT INTO C_MESSAGE_SEVERITY_TYPE (TYPE_CD, TYPE_NAME) VALUES ('LO', 'Low');

# Also see enum NotificationDeliveryMechanismTypeCode
INSERT INTO NOTIF_DELV_MECH_TYPE (TYPE_CD, TYPE_NAME) VALUES ('EM', 'Email');
INSERT INTO NOTIF_DELV_MECH_TYPE (TYPE_CD, TYPE_NAME) VALUES ('TX', 'Text');
