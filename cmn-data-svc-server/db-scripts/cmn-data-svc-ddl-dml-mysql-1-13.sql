...
CREATE TABLE C_GRP_PEER_MAP (
  GROUP_ID INT PRIMARY KEY AUTO_INCREMENT,
  PEER_ID CHAR(36) NOT NULL,
  CREATED_DATE TIMESTAMP NOT NULL,
  CONSTRAINT C_GRP_PEER_MAP_C_GROUP FOREIGN KEY (GROUP_ID) REFERENCES C_PEER_GROUP (GROUP_ID),
  CONSTRAINT C_GRP_PEER_MAP_C_PEER FOREIGN KEY (PEER_ID) REFERENCES C_PEER (PEER_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE C_GRP_SOL_MAP (
  GROUP_ID INT PRIMARY KEY AUTO_INCREMENT,
  SOLUTION_ID CHAR(36) NOT NULL,
  CREATED_DATE TIMESTAMP NOT NULL,
  CONSTRAINT C_SOL_PEER_MAP_C_GROUP FOREIGN KEY (GROUP_ID) REFERENCES C_PEER_GROUP (GROUP_ID),
  CONSTRAINT C_SOL_PEER_MAP_C_SOLUTION FOREIGN KEY (SOLUTION_ID) REFERENCES C_SOLUTION (SOLUTION_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE C_GRP_PEER_SOL_MAP (
  PEER_GROUP_ID INT NOT NULL, 
  SOL_GROUP_ID INT NOT NULL, 
  CREATED_DATE TIMESTAMP NOT NULL,
  PRIMARY KEY (PEER_GROUP_ID, SOL_GROUP_ID),
  CONSTRAINT C_GRP_PEER_SOL_C_PEER FOREIGN KEY (PEER_GROUP_ID) REFERENCES C_PEER_GROUP (GROUP_ID),
  CONSTRAINT C_GRP_PEER_SOL_C_SOLUTION FOREIGN KEY (SOL_GROUP_ID) REFERENCES C_SOLUTION_GROUP (GROUP_ID)  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE C_GRP_PEER_PEER_MAP (
  PRINCIPAL_GROUP_ID INT NOT NULL, 
  RESOURCE_GROUP_ID INT NOT NULL, 
  CREATED_DATE TIMESTAMP NOT NULL,
  PRIMARY KEY (PRINCIPAL_GROUP_ID, RESOURCE_GROUP_ID),
  CONSTRAINT C_GRP_PEER_PEER_C_PRINCIPAL FOREIGN KEY (PRINCIPAL_GROUP_ID) REFERENCES C_PEER_GROUP (GROUP_ID),
  CONSTRAINT C_GRP_PEER_PEER_C_RESOURCE  FOREIGN KEY (RESOURCE_GROUP_ID)  REFERENCES C_PEER_GROUP (GROUP_ID)  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
