...
CREATE TABLE C_PEER (
  ...
  LICENSE_STATUS_CD CHAR(2),
  VULNER_STATUS_CD CHAR(2),
  CREATED_DATE TIMESTAMP NOT NULL DEFAULT 0,
  MODIFIED_DATE TIMESTAMP NOT NULL,
...
INSERT INTO C_USER (USER_ID, LOGIN_NAME, LOGIN_HASH, EMAIL) VALUES ('12345678-abcd-90ab-cdef-1234567890ab', 'admin', '$2a$10$nogCM69/Vc0rEsZbHXlEm.nxSdGuD88Kd6NlW6fnKJz3AIz0PdOwa', '');
