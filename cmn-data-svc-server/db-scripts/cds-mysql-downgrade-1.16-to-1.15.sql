...
-- 12
ALTER TABLE C_USER DROP COLUMN API_TOKEN_HASH;
-- 11
ALTER TABLE C_SOLUTION_REV DROP COLUMN VULNER_STATUS_CD;
-- 10
ALTER TABLE C_SOLUTION_REV DROP COLUMN LICENSE_STATUS_CD;
-- 9
ALTER TABLE C_SOLUTION ADD COLUMN VALIDATION_STATUS_CD CHAR(2);
-- 8
